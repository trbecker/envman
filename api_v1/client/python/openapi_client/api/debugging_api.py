...
class DebuggingApi:
    ...
    @validate_call
    def u_e_get(self, **kwargs) -> UEGet200Response:  # noqa: E501
    ...
    def u_e_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UEGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_call
    def u_eimsi_info_get(self, i_msi : StrictStr, **kwargs) -> UEIMSIInfoGet200Response:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: UEIMSIInfoGet200Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
    ...
    def u_eimsi_info_get_with_http_info(self, i_msi : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UEIMSIInfoGet200Response, status_code(int), headers(HTTPHeaderDict))
        """
